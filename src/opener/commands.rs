...
use super::{scope::Scope, Error, OpenerExt};

#[tauri::command]
pub async fn open_url<R: Runtime>(
    app: AppHandle<R>,
    command_scope: CommandScope<super::scope::Entry>,
    global_scope: GlobalScope<super::scope::Entry>,
    url: String,
    with: Option<String>,
) -> super::Result<()> {
    let scope = Scope::new(
...
#[tauri::command]
pub async fn reveal_item_in_dir(paths: Vec<PathBuf>) -> super::Result<()> {
    super::reveal_items_in_dir(&paths)
}
