...
class FileHandle extends Resource {
  ...
  async read(buffer: Uint8Array): Promise<number | null> {
    ...
    const data = await invoke<ArrayBuffer | number[]>('plugin:advanced-file-manager|read', {
      rid: this.rid,
  ...
  async seek(offset: number, whence: SeekMode): Promise<number> {
    return await invoke('plugin:advanced-file-manager|seek', {
      rid: this.rid,
      offset,
      whence
    })
  ...
  async stat(): Promise<FileInfo> {
    const res = await invoke<UnparsedFileInfo>('plugin:advanced-file-manager|fstat', {
      rid: this.rid
    })
  ...
  async truncate(len?: number): Promise<void> {
    await invoke('plugin:advanced-file-manager|ftruncate', {
      rid: this.rid,
      len
    })
  }
  ...
  async write(data: Uint8Array): Promise<number> {
    return await invoke('plugin:advanced-file-manager|write', {
      rid: this.rid,
      data
    })
  }
...
async function create(
  ...
  const rid = await invoke<number>('plugin:advanced-file-manager|create', {
...
async function open(
  ...
  const rid = await invoke<number>('plugin:advanced-file-manager|open', {
    path: path instanceof URL ? path.toString() : path,
    options
  })
...
async function copyFile(
  ...
  await invoke('plugin:advanced-file-manager|copy_file', {
...
async function mkdir(
  ...
  await invoke('plugin:advanced-file-manager|mkdir', {
    path: path instanceof URL ? path.toString() : path,
    options
  })
}
...
async function readDir(
  ...
  return await invoke('plugin:advanced-file-manager|read_dir', {
    path: path instanceof URL ? path.toString() : path,
    options
  })
}
...
async function readFile(
  ...
  const arr = await invoke<ArrayBuffer | number[]>('plugin:advanced-file-manager|read_file', {
    path: path instanceof URL ? path.toString() : path,
    options
  })
...
async function readTextFile(
  ...
  const arr = await invoke<ArrayBuffer | number[]>('plugin:advanced-file-manager|read_text_file', {
    path: path instanceof URL ? path.toString() : path,
    options
  })
...
async function readTextFileLines(
  ...
  return await Promise.resolve({
    ...
    async next(): Promise<IteratorResult<string>> {
      if (this.rid === null) {
        this.rid = await invoke<number>('plugin:advanced-file-manager|read_text_file_lines', {
          path: pathStr,
          options
        })
      }
      ...
      const arr = await invoke<ArrayBuffer | number[]>(
        'plugin:advanced-file-manager|read_text_file_lines_next',
        { rid: this.rid }
      )
...
async function remove(
  ...
  await invoke('plugin:advanced-file-manager|remove', {
    path: path instanceof URL ? path.toString() : path,
    options
  })
}
...
async function rename(
  ...
  await invoke('plugin:advanced-file-manager|rename', {
...
async function stat(
  ...
  const res = await invoke<UnparsedFileInfo>('plugin:advanced-file-manager|stat', {
    path: path instanceof URL ? path.toString() : path,
    options
  })
...
async function lstat(
  ...
  const res = await invoke<UnparsedFileInfo>('plugin:advanced-file-manager|lstat', {
    path: path instanceof URL ? path.toString() : path,
    options
  })
...
async function truncate(
  ...
  await invoke('plugin:advanced-file-manager|truncate', {
    path: path instanceof URL ? path.toString() : path,
    len,
    options
  })
...
async function writeFile(
  ...
  if (data instanceof ReadableStream) {
    ...
    await invoke('plugin:advanced-file-manager|write_file', data, {
      headers: {
...
async function writeTextFile(
  ...
  await invoke('plugin:advanced-file-manager|write_text_file', encoder.encode(data), {
    headers: {
      path: encodeURIComponent(path instanceof URL ? path.toString() : path),
      options: JSON.stringify(options)
    }
...
async function exists(
  ...
  return await invoke('plugin:advanced-file-manager|exists', {
    path: path instanceof URL ? path.toString() : path,
    options
  })
}
...
async function watchInternal(
  ...
  const rid: number = await invoke('plugin:advanced-file-manager|watch', {
...
async function size(path: string | URL): Promise<number> {
  ...
  return await invoke('plugin:advanced-file-manager|size', {
    path: path instanceof URL ? path.toString() : path
  })
}
