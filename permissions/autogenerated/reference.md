...
`advanced-file-manager:allow-app-read-recursive`
...
`advanced-file-manager:allow-app-write-recursive`
...
`advanced-file-manager:allow-app-read`
...
`advanced-file-manager:allow-app-write`
...
`advanced-file-manager:allow-app-meta-recursive`
...
`advanced-file-manager:allow-app-meta`
...
`advanced-file-manager:scope-app-recursive`
...
`advanced-file-manager:scope-app`
...
`advanced-file-manager:scope-app-index`
...
`advanced-file-manager:allow-appcache-read-recursive`
...
`advanced-file-manager:allow-appcache-write-recursive`
...
`advanced-file-manager:allow-appcache-read`
...
`advanced-file-manager:allow-appcache-write`
...
`advanced-file-manager:allow-appcache-meta-recursive`
...
`advanced-file-manager:allow-appcache-meta`
...
`advanced-file-manager:scope-appcache-recursive`
...
`advanced-file-manager:scope-appcache`
...
`advanced-file-manager:scope-appcache-index`
...
`advanced-file-manager:allow-appconfig-read-recursive`
...
`advanced-file-manager:allow-appconfig-write-recursive`
...
`advanced-file-manager:allow-appconfig-read`
...
`advanced-file-manager:allow-appconfig-write`
...
`advanced-file-manager:allow-appconfig-meta-recursive`
...
`advanced-file-manager:allow-appconfig-meta`
...
`advanced-file-manager:scope-appconfig-recursive`
...
`advanced-file-manager:scope-appconfig`
...
`advanced-file-manager:scope-appconfig-index`
...
`advanced-file-manager:allow-appdata-read-recursive`
...
`advanced-file-manager:allow-appdata-write-recursive`
...
`advanced-file-manager:allow-appdata-read`
...
`advanced-file-manager:allow-appdata-write`
...
`advanced-file-manager:allow-appdata-meta-recursive`
...
`advanced-file-manager:allow-appdata-meta`
...
`advanced-file-manager:scope-appdata-recursive`
...
`advanced-file-manager:scope-appdata`
...
`advanced-file-manager:scope-appdata-index`
...
`advanced-file-manager:allow-applocaldata-read-recursive`
...
`advanced-file-manager:allow-applocaldata-write-recursive`
...
`advanced-file-manager:allow-applocaldata-read`
...
`advanced-file-manager:allow-applocaldata-write`
...
`advanced-file-manager:allow-applocaldata-meta-recursive`
...
`advanced-file-manager:allow-applocaldata-meta`
...
`advanced-file-manager:scope-applocaldata-recursive`
...
`advanced-file-manager:scope-applocaldata`
...
`advanced-file-manager:scope-applocaldata-index`
...
`advanced-file-manager:allow-applog-read-recursive`
...
`advanced-file-manager:allow-applog-write-recursive`
...
`advanced-file-manager:allow-applog-read`
...
`advanced-file-manager:allow-applog-write`
...
`advanced-file-manager:allow-applog-meta-recursive`
...
`advanced-file-manager:allow-applog-meta`
...
`advanced-file-manager:scope-applog-recursive`
...
`advanced-file-manager:scope-applog`
...
`advanced-file-manager:scope-applog-index`
...
`advanced-file-manager:allow-audio-read-recursive`
...
`advanced-file-manager:allow-audio-write-recursive`
...
`advanced-file-manager:allow-audio-read`
...
`advanced-file-manager:allow-audio-write`
...
`advanced-file-manager:allow-audio-meta-recursive`
...
`advanced-file-manager:allow-audio-meta`
...
`advanced-file-manager:scope-audio-recursive`
...
`advanced-file-manager:scope-audio`
...
`advanced-file-manager:scope-audio-index`
...
`advanced-file-manager:allow-cache-read-recursive`
...
`advanced-file-manager:allow-cache-write-recursive`
...
`advanced-file-manager:allow-cache-read`
...
`advanced-file-manager:allow-cache-write`
...
`advanced-file-manager:allow-cache-meta-recursive`
...
`advanced-file-manager:allow-cache-meta`
...
`advanced-file-manager:scope-cache-recursive`
...
`advanced-file-manager:scope-cache`
...
`advanced-file-manager:scope-cache-index`
...
`advanced-file-manager:allow-config-read-recursive`
...
`advanced-file-manager:allow-config-write-recursive`
...
`advanced-file-manager:allow-config-read`
...
`advanced-file-manager:allow-config-write`
...
`advanced-file-manager:allow-config-meta-recursive`
...
`advanced-file-manager:allow-config-meta`
...
`advanced-file-manager:scope-config-recursive`
...
`advanced-file-manager:scope-config`
...
`advanced-file-manager:scope-config-index`
...
`advanced-file-manager:allow-data-read-recursive`
...
`advanced-file-manager:allow-data-write-recursive`
...
`advanced-file-manager:allow-data-read`
...
`advanced-file-manager:allow-data-write`
...
`advanced-file-manager:allow-data-meta-recursive`
...
`advanced-file-manager:allow-data-meta`
...
`advanced-file-manager:scope-data-recursive`
...
`advanced-file-manager:scope-data`
...
`advanced-file-manager:scope-data-index`
...
`advanced-file-manager:allow-desktop-read-recursive`
...
`advanced-file-manager:allow-desktop-write-recursive`
...
`advanced-file-manager:allow-desktop-read`
...
`advanced-file-manager:allow-desktop-write`
...
`advanced-file-manager:allow-desktop-meta-recursive`
...
`advanced-file-manager:allow-desktop-meta`
...
`advanced-file-manager:scope-desktop-recursive`
...
`advanced-file-manager:scope-desktop`
...
`advanced-file-manager:scope-desktop-index`
...
`advanced-file-manager:allow-document-read-recursive`
...
`advanced-file-manager:allow-document-write-recursive`
...
`advanced-file-manager:allow-document-read`
...
`advanced-file-manager:allow-document-write`
...
`advanced-file-manager:allow-document-meta-recursive`
...
`advanced-file-manager:allow-document-meta`
...
`advanced-file-manager:scope-document-recursive`
...
`advanced-file-manager:scope-document`
...
`advanced-file-manager:scope-document-index`
...
`advanced-file-manager:allow-download-read-recursive`
...
`advanced-file-manager:allow-download-write-recursive`
...
`advanced-file-manager:allow-download-read`
...
`advanced-file-manager:allow-download-write`
...
`advanced-file-manager:allow-download-meta-recursive`
...
`advanced-file-manager:allow-download-meta`
...
`advanced-file-manager:scope-download-recursive`
...
`advanced-file-manager:scope-download`
...
`advanced-file-manager:scope-download-index`
...
`advanced-file-manager:allow-exe-read-recursive`
...
`advanced-file-manager:allow-exe-write-recursive`
...
`advanced-file-manager:allow-exe-read`
...
`advanced-file-manager:allow-exe-write`
...
`advanced-file-manager:allow-exe-meta-recursive`
...
`advanced-file-manager:allow-exe-meta`
...
`advanced-file-manager:scope-exe-recursive`
...
`advanced-file-manager:scope-exe`
...
`advanced-file-manager:scope-exe-index`
...
`advanced-file-manager:allow-font-read-recursive`
...
`advanced-file-manager:allow-font-write-recursive`
...
`advanced-file-manager:allow-font-read`
...
`advanced-file-manager:allow-font-write`
...
`advanced-file-manager:allow-font-meta-recursive`
...
`advanced-file-manager:allow-font-meta`
...
`advanced-file-manager:scope-font-recursive`
...
`advanced-file-manager:scope-font`
...
`advanced-file-manager:scope-font-index`
...
`advanced-file-manager:allow-home-read-recursive`
...
`advanced-file-manager:allow-home-write-recursive`
...
`advanced-file-manager:allow-home-read`
...
`advanced-file-manager:allow-home-write`
...
`advanced-file-manager:allow-home-meta-recursive`
...
`advanced-file-manager:allow-home-meta`
...
`advanced-file-manager:scope-home-recursive`
...
`advanced-file-manager:scope-home`
...
`advanced-file-manager:scope-home-index`
...
`advanced-file-manager:allow-localdata-read-recursive`
...
`advanced-file-manager:allow-localdata-write-recursive`
...
`advanced-file-manager:allow-localdata-read`
...
`advanced-file-manager:allow-localdata-write`
...
`advanced-file-manager:allow-localdata-meta-recursive`
...
`advanced-file-manager:allow-localdata-meta`
...
`advanced-file-manager:scope-localdata-recursive`
...
`advanced-file-manager:scope-localdata`
...
`advanced-file-manager:scope-localdata-index`
...
`advanced-file-manager:allow-log-read-recursive`
...
`advanced-file-manager:allow-log-write-recursive`
...
`advanced-file-manager:allow-log-read`
...
`advanced-file-manager:allow-log-write`
...
`advanced-file-manager:allow-log-meta-recursive`
...
`advanced-file-manager:allow-log-meta`
...
`advanced-file-manager:scope-log-recursive`
...
`advanced-file-manager:scope-log`
...
`advanced-file-manager:scope-log-index`
...
`advanced-file-manager:allow-picture-read-recursive`
...
`advanced-file-manager:allow-picture-write-recursive`
...
`advanced-file-manager:allow-picture-read`
...
`advanced-file-manager:allow-picture-write`
...
`advanced-file-manager:allow-picture-meta-recursive`
...
`advanced-file-manager:allow-picture-meta`
...
`advanced-file-manager:scope-picture-recursive`
...
`advanced-file-manager:scope-picture`
...
`advanced-file-manager:scope-picture-index`
...
`advanced-file-manager:allow-public-read-recursive`
...
`advanced-file-manager:allow-public-write-recursive`
...
`advanced-file-manager:allow-public-read`
...
`advanced-file-manager:allow-public-write`
...
`advanced-file-manager:allow-public-meta-recursive`
...
`advanced-file-manager:allow-public-meta`
...
`advanced-file-manager:scope-public-recursive`
...
`advanced-file-manager:scope-public`
...
`advanced-file-manager:scope-public-index`
...
`advanced-file-manager:allow-resource-read-recursive`
...
`advanced-file-manager:allow-resource-write-recursive`
...
`advanced-file-manager:allow-resource-read`
...
`advanced-file-manager:allow-resource-write`
...
`advanced-file-manager:allow-resource-meta-recursive`
...
`advanced-file-manager:allow-resource-meta`
...
`advanced-file-manager:scope-resource-recursive`
...
`advanced-file-manager:scope-resource`
...
`advanced-file-manager:scope-resource-index`
...
`advanced-file-manager:allow-runtime-read-recursive`
...
`advanced-file-manager:allow-runtime-write-recursive`
...
`advanced-file-manager:allow-runtime-read`
...
`advanced-file-manager:allow-runtime-write`
...
`advanced-file-manager:allow-runtime-meta-recursive`
...
`advanced-file-manager:allow-runtime-meta`
...
`advanced-file-manager:scope-runtime-recursive`
...
`advanced-file-manager:scope-runtime`
...
`advanced-file-manager:scope-runtime-index`
...
`advanced-file-manager:allow-temp-read-recursive`
...
`advanced-file-manager:allow-temp-write-recursive`
...
`advanced-file-manager:allow-temp-read`
...
`advanced-file-manager:allow-temp-write`
...
`advanced-file-manager:allow-temp-meta-recursive`
...
`advanced-file-manager:allow-temp-meta`
...
`advanced-file-manager:scope-temp-recursive`
...
`advanced-file-manager:scope-temp`
...
`advanced-file-manager:scope-temp-index`
...
`advanced-file-manager:allow-template-read-recursive`
...
`advanced-file-manager:allow-template-write-recursive`
...
`advanced-file-manager:allow-template-read`
...
`advanced-file-manager:allow-template-write`
...
`advanced-file-manager:allow-template-meta-recursive`
...
`advanced-file-manager:allow-template-meta`
...
`advanced-file-manager:scope-template-recursive`
...
`advanced-file-manager:scope-template`
...
`advanced-file-manager:scope-template-index`
...
`advanced-file-manager:allow-video-read-recursive`
...
`advanced-file-manager:allow-video-write-recursive`
...
`advanced-file-manager:allow-video-read`
...
`advanced-file-manager:allow-video-write`
...
`advanced-file-manager:allow-video-meta-recursive`
...
`advanced-file-manager:allow-video-meta`
...
`advanced-file-manager:scope-video-recursive`
...
`advanced-file-manager:scope-video`
...
`advanced-file-manager:scope-video-index`
...
`advanced-file-manager:allow-ask`
...
`advanced-file-manager:deny-ask`
...
`advanced-file-manager:allow-confirm`
...
`advanced-file-manager:deny-confirm`
...
`advanced-file-manager:allow-copy-file`
...
`advanced-file-manager:deny-copy-file`
...
`advanced-file-manager:allow-create`
...
`advanced-file-manager:deny-create`
...
`advanced-file-manager:deny-exists`
...
`advanced-file-manager:allow-fstat`
...
`advanced-file-manager:deny-fstat`
...
`advanced-file-manager:allow-ftruncate`
...
`advanced-file-manager:deny-ftruncate`
...
`advanced-file-manager:allow-lstat`
...
`advanced-file-manager:deny-lstat`
...
`advanced-file-manager:allow-message`
...
`advanced-file-manager:deny-message`
...
`advanced-file-manager:allow-mkdir`
...
`advanced-file-manager:deny-mkdir`
...
`advanced-file-manager:allow-open`
...
`advanced-file-manager:deny-open`
...
`advanced-file-manager:allow-read`
...
`advanced-file-manager:deny-read`
...
`advanced-file-manager:deny-read-dir`
...
`advanced-file-manager:deny-read-file`
...
`advanced-file-manager:allow-read-text-file`
...
`advanced-file-manager:deny-read-text-file`
...
`advanced-file-manager:allow-read-text-file-lines`
...
`advanced-file-manager:deny-read-text-file-lines`
...
`advanced-file-manager:allow-read-text-file-lines-next`
...
`advanced-file-manager:deny-read-text-file-lines-next`
...
`advanced-file-manager:allow-remove`
...
`advanced-file-manager:deny-remove`
...
`advanced-file-manager:allow-rename`
...
`advanced-file-manager:deny-rename`
...
`advanced-file-manager:allow-save`
...
`advanced-file-manager:deny-save`
...
`advanced-file-manager:allow-seek`
...
`advanced-file-manager:deny-seek`
...
`advanced-file-manager:allow-size`
...
`advanced-file-manager:deny-size`
...
`advanced-file-manager:allow-stat`
...
`advanced-file-manager:deny-stat`
...
`advanced-file-manager:allow-truncate`
...
`advanced-file-manager:deny-truncate`
...
`advanced-file-manager:allow-unwatch`
...
`advanced-file-manager:deny-unwatch`
...
`advanced-file-manager:allow-watch`
...
`advanced-file-manager:deny-watch`
...
`advanced-file-manager:allow-write`
...
`advanced-file-manager:deny-write`
...
`advanced-file-manager:deny-write-file`
...
`advanced-file-manager:allow-write-text-file`
...
`advanced-file-manager:deny-write-text-file`
...
`advanced-file-manager:create-app-specific-dirs`
...
`advanced-file-manager:deny-default`
...
`advanced-file-manager:deny-webview-data-linux`
...
`advanced-file-manager:deny-webview-data-windows`
...
`advanced-file-manager:read-all`
...
`advanced-file-manager:read-app-specific-dirs-recursive`
...
`advanced-file-manager:read-dirs`
...
`advanced-file-manager:read-files`
...
`advanced-file-manager:read-meta`
...
`advanced-file-manager:write-all`
...
`advanced-file-manager:write-files`
